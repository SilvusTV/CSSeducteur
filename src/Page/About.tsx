...
export default function About() {
  return (
    <div className={"flex min-h-screen flex-col items-center justify-between"}>
      <MetaHead
        title={
          "CSSeducteur : Le Charme Révélé - Découvrez l'essence de CSSéducteur"
        }
      ...
      >
        ...
        <article>
          <h2 className={"mt-1 text-2xl font-bold"}>Qui sommes-nous ?</h2>
          <p className={"mb-5 text-xl"}>
            ...
            vos projets. Nous croyons que chaque développeur mérite un
          ...
          <p className={"mb-5 text-xl"}>
            La séduction, c'est un art, tout comme le développement web. Tout
            comme un partenaire idéal, un bon framework CSS doit s'adapter à vos
            besoins, vous inspirer et vous aider à révéler tout le potentiel de
            vos projets. CSSéducteur joue avec cette analogie pour rendre votre
            exploration des outils front-end aussi amusante qu'enrichissante.
          </p>

          <h2 className={"mt-1 text-2xl font-bold"}>
            Un espace pour les passionnés
          </h2>
          <p className={"text-xl"}>
            CSSéducteur, c'est aussi une communauté. Notre blog regorge
            d'articles captivants, d'exemples concrets et de retours
            d'expérience pour enrichir vos connaissances. Rejoignez-nous pour
            partager vos découvertes, poser des questions et continuer à
            apprendre.
          </p>
          <p className={"mb-5 text-xl"}>
            Consultez notre{" "}
            <a
              className={"underline"}
              href="/blog"
              title="Visitez notre blog CSSéducteur"
            >
              blog ici
            </a>{" "}
            pour plonger dans un univers de charme et d'expertise.
          </p>

          <h2 className={"mt-1 text-2xl font-bold"}>Nos valeurs</h2>
          ...
          <p className={"text-xl"}>
            CSSéducteur est une invitation à explorer, expérimenter et
            apprendre. Suivez-nous sur nos réseaux sociaux pour ne rien manquer
            et rejoignez des milliers de développeurs séduits par notre vision.
          </p>
          <p className={"mb-5 text-xl"}>
            Vous avez une question ou une suggestion ? Nous sommes là pour
            échanger :
            <a className={"underline"} href="/contact" title="Contactez-nous">
              {" "}
              Contactez-nous
            </a>
            .
